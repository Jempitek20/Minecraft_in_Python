...
void setup(){auto cfg=M5.config();M5Cardputer.begin(cfg);M5Cardputer.Display.setRotation(1);randomSeed(esp_random());for(auto &b:pop)randomBrain(b);champion.fitness=-1;}
